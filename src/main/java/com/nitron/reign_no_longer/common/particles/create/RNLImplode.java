...
public class RNLImplode extends SpriteBillboardParticle {
    private final Quaternionf randomRotation;

    public RNLImplode(ClientWorld world, double x, double y, double z) {
        super(world, x, y, z);
        this.scale = 100;
        this.maxAge = 500;
    ...
    private void triggerEffect(){
        ...
        ClientPlayNetworking.send(new Identifier(ReignNoLonger.MOD_ID, "explode"), buf);
    }
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType>{
        ...
        public Particle createParticle(DefaultParticleType effect, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            RNLImplode particle = new RNLImplode(world, x, y, z);
